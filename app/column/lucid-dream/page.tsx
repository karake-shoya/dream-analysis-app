...
const FAQS = [
  ...
  { q: '明晰夢と睡眠麻痺（金縛り）は同じですか？', a: '異なる現象です。睡眠麻痺はレム睡眠時に覚醒と睡眠の間で体が動かなくなる状態です。明晰夢は夢の中で自由に動けて意識も鮮明な状態であり、体験としてはまったく異なります。' },
  { q: '明晰夢は毎晩見ることができますか？', a: '最初のうちは数週間に1回程度が一般的です。WBTB法（早朝再入眠法）とMILD法を組み合わせると頻度が上がりますが、睡眠の質を犠牲にして試みることは避けてください。習慣として定着すると、月に数回体験できる人が増えてきます。' },
];

export const metadata = buildColumnMetadata('lucid-dream');
...
export default function LucidDreamPage() {
  return (
    <ColumnArticleShell
      ...
      faqs={FAQS}
      faqVariant="qa"
      disclaimer="※本ページの内容は、科学的・心理学的な一般知識をもとにした情報提供を目的としており、医学的な診断・治療を行うものではありません。睡眠の不調が続く場合は、専門家にご相談ください。"
      cta={{
        title: '夢の内容が気になるときは',
