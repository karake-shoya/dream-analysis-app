...
const FAQS = [
  { q: '歯が抜ける夢は不吉なサインですか？', a: '必ずしも不吉ではありません。歯が抜ける夢は、自信の揺らぎや変化への不安、コミュニケーションへの緊張が高まっているときに見やすい夢です。「今の自分の状態を見直すサイン」として受け取ることで、日常の何かに気づくきっかけになることがあります。' },
  { q: '歯が次々と抜ける夢と1本だけ抜ける夢では意味が違いますか？', a: '心理学的には、抜け方の規模が「不安の強度」と関連しやすいと言われます。1本だけ抜ける夢は局所的な緊張や小さな自信の揺らぎを、次々と抜ける夢はより広い範囲での喪失感や大きな変化への不安を象徴することがあります。ただし夢の解釈は夢全体の雰囲気や目覚めたときの感情も重要です。' },
  { q: '繰り返し歯が抜ける夢を見るのはなぜですか？', a: 'ユング心理学では、繰り返す夢はその象徴するテーマがまだ解消されていないサインとされています。自信の喪失・コミュニケーションへの不安・大きな変化への恐れといった課題が、意識の上では処理されていても、深層心理では残り続けているときに繰り返されることがあります。' },
  { q: '歯が抜ける夢を見た翌日にできることはありますか？', a: '目覚めたとき感じた感情（怖かった、痛かった、意外と平気だったなど）を短くメモしておくのがおすすめです。次に「最近自信が揺らいでいることや、避けているコミュニケーションはないか」を静かに問いかけてみてください。答えが出なくても、問い自体が深層心理に働きかけます。' },
  { q: '歯が抜ける夢を見やすい人はどんな人ですか？', a: '人生の転換期（就職・転職・引越・進学・離別など）を迎えている人、対人関係で気を遣いすぎている人、完璧主義で失敗を恐れやすい人がこの夢を見やすい傾向があります。また、日中に抑圧したストレスが睡眠中に表れやすいため、感受性が高く物事を深く考えるタイプにも多く見られます。' },
];

export const metadata = buildColumnMetadata('falling-teeth-dream');

export default function FallingTeethDreamPage() {
  return (
    <ColumnArticleShell
      slug="falling-teeth-dream"
      heroTitle="歯が抜ける夢の意味とは"
      heroSubtitle="自信・変化・コミュニケーション——深層心理が映し出すもの"
      faqs={FAQS}
      references={[
      ...
      nextColumn={{
        ...
        emoji: '😰',
        heading: '怖い夢・悪夢が続くときの読み解き方も確認しませんか？',
        sub: '深層心理が示す不安のサインと対処法',
      }}
      cta={{
