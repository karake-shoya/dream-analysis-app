...
const FAQS = [
  { q: '死ぬ夢は不吉なサインですか？', a: '心理学的には不吉な予兆ではありません。死ぬ夢は「何かが終わり、新しいものが始まる」変化のシンボルとしてユング心理学では解釈されます。古い自己像・習慣・関係パターンが終わりを迎えるタイミングに見やすく、変容・再生のプロセスを示すことが多い夢です。' },
  { q: '自分が死ぬ夢と、誰かが死ぬ夢では意味が違いますか？', a: '自分が死ぬ夢は自己変容・古い自分の終わりを、誰かが死ぬ夢はその人が象徴するもの（関係・感情・役割）の終わりや変化を示すことがあります。夢の中で誰かが死んでも、現実のその人への予言ではなく、自分の内面にあるその人への感情や関係性の変化を映していることが多いです。' },
  { q: '死んだ後に別の場所で生きている夢はどんな意味ですか？', a: '死後も別の形で生き続ける夢は、再生・変容・新しいステージへの移行を象徴することが多く、ユング的には個性化プロセスにおける「古い自己の死と新しい自己の誕生」として肯定的に解釈されます。' },
  { q: '死ぬことへの恐怖を感じる夢と、安らかな死の夢では意味が違いますか？', a: '夢の中の感情は重要な手がかりです。恐怖を感じる死の夢は、変化への抵抗・失う恐れ・コントロールを手放せない状態を、安らかな死の夢は変化を受け入れる準備ができている・古いものへの執着を手放せる状態を示すことがあります。' },
  { q: '死ぬ夢を見て目が覚めた後、何かすべきことはありますか？', a: '目覚めた直後の感情（恐怖・安堵・混乱など）と、夢のシーンを短くメモしておきましょう。次に「今の自分の生活で何かが終わろうとしているか」「変えたいと思っているのに変えられていないことはあるか」を静かに問いかけてみてください。死の夢は「終わり」だけでなく「始まり」のメッセージであることが多いです。' },
];

export const metadata = buildColumnMetadata('death-dream');
...
export default function DeathDreamPage() {
  return (
    <ColumnArticleShell
      slug="death-dream"
      heroTitle="死ぬ夢の意味とは"
      heroSubtitle="終わりではなく変容のサイン——深層心理が告げること"
      faqs={FAQS}
      references={[
      ...
      nextColumn={{
        ...
        emoji: '🔄',
        heading: '同じ夢を繰り返し見ることが気になりますか？',
        sub: '繰り返す夢の心理学的な理由と止め方',
      }}
      cta={{
