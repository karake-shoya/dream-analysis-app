...
const SLEEPING_POSITIONS: SleepingPosition[] = [
  {
    name: "密着寝",
    imageUrl: "/images/sleeping-positions/pos_01.png",
  ...
  {
    name: "向き合い寝",
    imageUrl: "/images/sleeping-positions/pos_02.png",
  ...
  {
    name: "手つなぎ寝",
    imageUrl: "/images/sleeping-positions/pos_03.png",
  ...
  {
    name: "絡み合い寝",
    imageUrl: "/images/sleeping-positions/pos_04.png",
  ...
  {
    name: "背中接触寝",
    imageUrl: "/images/sleeping-positions/pos_05.png",
  ...
  {
    name: "背中きょり寝",
    imageUrl: "/images/sleeping-positions/pos_06.png",
  ...
  {
    name: "胸まくら寝",
    imageUrl: "/images/sleeping-positions/pos_07.png",
  ...
  {
    name: "スペース大きめ寝",
    imageUrl: "/images/sleeping-positions/pos_08.png",
          ...
          <div className="max-w-6xl mx-auto space-y-12">
            <section className="text-center space-y-6 pt-8">
              ...
              <p className="text-gray-300 text-lg leading-relaxed max-w-4xl mx-auto">
                ...
                5つの質問でいまの寝相タイプをチェックし、15のパターンから深層心理を探ってみましょう。
              </p>
            </section>
